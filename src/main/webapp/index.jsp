...
<div class="hero-wrap js-fullheight" style="${pageContext.request.contextPath}/background-image: url('images/bg_1.jpg');"
    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start"
            ...
            <div class="col-xl-10 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"> 大型活动时间 <br><span>具体时间 2019</span>
                </h1>
        ...
        <div class="row">
            <div class="col-md-12 ftco-animate">
                <div class="carousel-testimony owl-carousel">
                    ...
                    <div class="item">
                        <div class="speaker">
                            <img src="images/kongfu.jpg" class="img-fluid" alt="Colorlib HTML5 Template">
                            <div class="text text-center py-3">
                                <h3>武术社团</h3>
                    ...
                    <div class="item">
                        <div class="speaker">
                            <img src="images/skate.jpg" class="img-fluid" alt="Colorlib HTML5 Template">
                            <div class="text text-center py-3">
                                <h3>轮滑社</h3>
                    ...
                    <div class="item">
                        <div class="speaker">
                            <img src="images/poem.jpg" class="img-fluid" alt="Colorlib HTML5 Template">
                            <div class="text text-center py-3">
                                <h3>古诗文社</h3>
                ...
                <div class="col-md-12 nav-link-wrap">
                    <div class="nav nav-pills d-flex text-center" id="v-pills-tab" role="tablist"
                        ...
                        <a class="nav-link ftco-animate" id="v-pills-2-tab" data-toggle="pill" href="#v-pills-2"
                           role="tab" aria-controls="v-pills-2" aria-selected="false">Day 02
                            <span>22 Dec. 2019</span></a>

                        <a class="nav-link ftco-animate" id="v-pills-3-tab" data-toggle="pill" href="#v-pills-3"
                           role="tab" aria-controls="v-pills-3" aria-selected="false">Day 03
                            <span>23 Dec. 2019</span></a>

                        <a class="nav-link ftco-animate" id="v-pills-4-tab" data-toggle="pill" href="#v-pills-4"
                           role="tab" aria-controls="v-pills-4" aria-selected="false">Day 04
                            <span>24 Dec. 2019</span></a>
                ...
                <div class="col-md-12 tab-wrap">
                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel"
                            ...
                            <div class="speaker-wrap ftco-animate d-flex">
                                <div class="img speaker-img"
                                     style="background-image: url(images/basketball01.jpg);"></div>
                                <div class="text pl-md-5">
                                    <span class="time">08: - 10:00</span>
                                    <h2><a href="#">篮球社区总决赛</a></h2>
                                    <p>理学院“湖人队”和轻工学院“猛龙队”经过一系列的抉择，站在了总决赛的赛场上，每个球员激情澎湃，热血腾腾，双方都势在必得。</p>
                                    <h3 class="speaker-name">&mdash; <a href="#">“湖人队VS猛龙队”</a> <span class="position">拭目以待</span>
                                    </h3>
                                </div>
                            </div>
                            <div class="speaker-wrap ftco-animate d-flex">
                                <div class="img speaker-img" style="background-image: url(images/literature.jpg);"></div>
                                <div class="text pl-md-5">
                                    <span class="time">08: - 10:00</span>
                                    <h2><a href="#">文艺大赛</a></h2>
                                    <p>这是文艺社团一年一度的文艺展览大会，届时会有很多多才多艺的社员给我们表演他们的才艺</p>
                                    <h3 class="speaker-name">&mdash;<a href="#">文艺大赛不容错过</a> <span class="position">等待你们哟</span>
                                    </h3>
                                </div>
                            </div>
                            <div class="speaker-wrap ftco-animate d-flex">
                                <div class="img speaker-img"
                                     style="background-image: url(images/poem.jpg);"></div>
                                <div class="text pl-md-5">
                                    <span class="time">08: - 10:00</span>
                                    <h2><a href="#">古诗文朗诵</a></h2>
                                    <p>古诗文社团为对古代诗人的追念而组织的一场诗文朗诵，有不同时代，不同风格的诗文都会以不同的形式展现出来</p>
                                    <h3 class="speaker-name">&mdash; <a href="#">李白、仓央嘉措</a> <span
                                            class="position">以诗会友</span></h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="v-pills-2" role="tabpanel" aria-labelledby="v-pills-day-2-tab">
                            <div class="speaker-wrap ftco-animate d-flex">
                                <div class="img speaker-img" style="background-image: url(images/skate.jpg);"></div>
                                <div class="text pl-md-5">
                                    <span class="time">08: - 10:00</span>
                                    <h2><a href="#">轮滑比赛</a></h2>
                                    <p>轮滑爱好者自发组织的一场大型群体轮滑比赛，可以在比赛的同时展现自己在轮滑上的造诣 </p>
                                    <h3 class="speaker-name">&mdash; <a href="#">轮滑爱好者</a> <span class="position">滑出不一样的精彩人生</span>
                                    </h3>
                                </div>
                            </div>
                            <div class="speaker-wrap ftco-animate d-flex">
                                <div class="img speaker-img" style="background-image: url(images/cartoon01.jpg);"></div>
                                <div class="text pl-md-5">
                                    <span class="time">08: - 10:00</span>
                                    <h2><a href="#">cosplay表演</a></h2>
                                    <p>动漫社组织的各类动漫活动和Cosplay表演</p>
                                    <h3 class="speaker-name">&mdash; <a href="#">二次元</a> <span class="position">展现动漫活力,体验飞扬青春</span>
                                    </h3>
                                </div>
                            </div>
                            <div class="speaker-wrap ftco-animate d-flex">
                                <div class="img speaker-img" style="background-image: url(images/kongfu01.jpg);"></div>
                                <div class="text pl-md-5">
                                    <span class="time">08: - 10:00</span>
                                    <h2><a href="#">武术才艺表演</a></h2>
                                    <p>这是武术社团组着的一场才艺表演，有梅花拳，盘龙棍，洪家拳等才艺表演</p>
                                    <h3 class="speaker-name">&mdash; <a href="#">梅花拳</a> <span class="position">让我们拥有完美的体魄</span>
                                    </h3>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="v-pills-3" role="tabpanel" aria-labelledby="v-pills-day-3-tab">
                            <div class="speaker-wrap ftco-animate d-flex">
                                ...
                                <div class="text pl-md-5">
                                    ...
                                    <h3 class="speaker-name">&mdash; <a href="#">机器人</a> <span
                                            class="position">与科技为伍</span></h3>
                                </div>
                            </div>
                            <div class="speaker-wrap ftco-animate d-flex">
                                <div class="img speaker-img"
                                     style="background-image: url(images/badminton.jpg);"></div>
                                <div class="text pl-md-5">
                                    <span class="time">08: - 10:00</span>
                                    <h2><a href="#">羽毛球赛</a></h2>
                                    <p>羽毛球社团组织的球赛，届时有很多对羽毛球爱好者参加，来切磋球技，互娱互乐。</p>
                                    <h3 class="speaker-name">&mdash; <a href="#">羽毛球</a> <span
                                            class="position">放飞自我</span></h3>
                                </div>
                            </div>
                            <div class="speaker-wrap ftco-animate d-flex">
                                <div class="img speaker-img"
                                ...
                                <div class="text pl-md-5">
                                    ...
                                    <h3 class="speaker-name">&mdash; <a href="#">Brett Morgan</a> <span
                                            class="position">以球会友</span></h3>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="v-pills-4" role="tabpanel" aria-labelledby="v-pills-day-4-tab">
                            <div class="speaker-wrap ftco-animate d-flex">
                                <div class="img speaker-img" style="background-image: url(images/baseball.jpg);"></div>
                                <div class="text pl-md-5">
                                    <span class="time">08: - 10:00</span>
                                    <h2><a href="#">棒球赛</a></h2>
                                    <p>棒球社团组织的球赛，届时有很多对棒球爱好者参加，来切磋球技，互娱互乐。</p>
                                    <h3 class="speaker-name">&mdash; <a href="#">棒球</a> <span
                                            class="position">以球会友</span></h3>
                                </div>
                            </div>
                            <div class="speaker-wrap ftco-animate d-flex">
                                <div class="img speaker-img" style="background-image: url(images/ping-pong.jpg);"></div>
                                <div class="text pl-md-5">
                                    <span class="time">08: - 10:00</span>
                                    <h2><a href="#">乒乓球比赛</a></h2>
                                    <p>乒乓球社团组织的球赛，届时有很多对乒乓球爱好者参加，来切磋球技，互娱互乐。 </p>
                                    <h3 class="speaker-name">&mdash; <a href="#">乒乓球</a> <span
                                            class="position">以球会友</span></h3>
                                </div>
                            </div>
                            <div class="speaker-wrap ftco-animate d-flex">
                                ...
                                <div class="text pl-md-5">
                                    ...
                                    <h3 class="speaker-name">&mdash; <a href="#">足球赛</a> <span
                                            class="position">以球会友</span></h3>
                                </div>
                            </div>
                        </div>
