        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
            ...
            <div class="col-xl-4 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                ...
                <form action="${pageContext.request.contextPath}/login/logincheck" method="post">
                    ...
                    <input type="text"name ="username" id="inputText1" class="form-control" placeholder="用户名" required autofocus>

                    <input type="text"name ="id" id="inputText2" class="form-control" placeholder="学号" required autofocus>

                    <input type="text"name ="name" id="inputText3" class="form-control" placeholder="姓名" required autofocus>

                    <input type="email"name="email" class="form-control" id="exampleInputEmail1" placeholder="邮箱"required autofocus>

                    <input type="password" name="password" id="inputPassword1" class="form-control" placeholder="密码" required>

                    <input type="password" name="password" id="inputPassword2" class="form-control" placeholder="再次输入密码" required>
