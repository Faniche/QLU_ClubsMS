    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
            ...
            <div class="col-xl-4 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                <span><a href="${pageContext.request.contextPath}/login/login" class="">账号登录</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/login/email" class="">邮箱登录</a></span>
                ...
                <form action="${pageContext.request.contextPath}/login/loginStucheck" method="post">
                    ...
                    <input type="text"name="id" id="inputText" class="form-control" placeholder="学号" required autofocus>
