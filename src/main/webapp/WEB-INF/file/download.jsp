...
<section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('${pageContext.request.contextPath}/images/bg_2.jpg');" data-stellar-background-ratio="0.5">
    <div class="overlay"></div>
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
            <div class="col-md-9 ftco-animate pb-5">
                <h1 class="mb-3 bread">下载专区</h1>
                <p class="breadcrumbs"><span class="mr-2"><a href="home.html">首页 <i class="ion-ios-arrow-forward"></i></a></span> <span>下载专区 <i class="ion-ios-arrow-forward"></i></span></p>
            </div>
        </div>
    </div>
</section>
