    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
            <div class="col-md-9 ftco-animate pb-5">
                ...
                <p class="breadcrumbs"><span class="mr-2"><a href="index1.html">首页 <i class="ion-ios-arrow-forward"></i></a></span> <span>我的消息 <i class="ion-ios-arrow-forward"></i></span></p>
            </div>
        </div>
    </div>
</section>
                        ...
                        <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="day-1-tab">
                            <div class="speaker-wrap ftco-animate d-flex">
                                ...
                                <div class="text pl-md-5">
                                    ...
                                    <h3 class="speaker-name">&mdash; <a href="#">武术社</a> <span class="position">郭雅楠</span></h3>
                                    <p><button type="button" class="btn btn-success">同意</button>&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-danger">拒绝</button>
